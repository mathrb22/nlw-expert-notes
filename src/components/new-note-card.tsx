...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
	...
	function handleSaveNote(event: FormEvent) {
		if (content === '')
			return toast.error('A nota não pode estar vazia!', {
				position: 'top-center',
				duration: 2500,
			});
					...
					<form className='flex flex-1 flex-col '>
						...
						{isRecording ? (
							<button
								...
								className='w-full flex items-center justify-center gap-2 bg-slate-900 hover:text-slate-300 text-slate-100 py-4 text-center text-sm font-semibold outline-none group focus-visible:ring-2 focus-visible:ring-lime-600 transition-all'>
